...
const CATEGORY_FIELDS: Record<string, CategoryConfig> = {
    'ডাক্তার': {
        ...
        fields: [
            ...
            { key: 'specialty', label: 'কীসের ডাক্তার (বিশেষজ্ঞতা)', placeholder: 'হৃদরোগ / চর্ম / শিশু / মেডিসিন', type: 'select', options: ['মনোরোগ বিশেষজ্ঞ', 'হৃদরোগ বিশেষজ্ঞ', 'পাইলস বিশেষজ্ঞ', 'ডেন্টিস্ট', 'চর্ম ও যৌন রোগ', 'ডায়াবেটিস ও হরমোন', 'নাক, কান ও গলা', 'চক্ষু বিশেষজ্ঞ', 'লিভার বিশেষজ্ঞ', 'ইউরোলজি', 'সার্জারি', 'গাইনি বিশেষজ্ঞ', 'রক্তরোগ বিশেষজ্ঞ', 'হোমিওপ্যাথি', 'লেজার সার্জারি', 'মেডিসিন বিশেষজ্ঞ', 'কিডনি রোগ বিশেষজ্ঞ', 'নিউরো সার্জারি', 'স্নায়ু রোগ বিশেষজ্ঞ', 'পুষ্টি বিশেষজ্ঞ', 'ক্যান্সার বিশেষজ্ঞ', 'অর্থোপেডিক', 'ব্যাথা বিশেষজ্ঞ', 'শিশু রোগ বিশেষজ্ঞ', 'ফিজিক্যাল মেডিসিন', 'ফিজিও থেরাপিস্ট', 'প্লাস্টিক সার্জারি', 'বক্ষব্যাধি বিশেষজ্ঞ', 'অ্যানাস্থেসিওলজিস্ট', 'পশু চিকিৎসক'], highlight: true, required: true },
            { key: 'chamber', label: 'একাধিক চেম্বারের বিস্তারিত', placeholder: 'একাধিক চেম্বার থাকলে সবগুলোর নাম ও বিস্তারিত ঠিকানা লিখুন', type: 'textarea' },
            { key: 'map_link', label: 'গুগল ম্যাপ লিংক', placeholder: 'সরাসরি গুগল ম্যাপের লোকেশন লিংক (যদি থাকে)', type: 'text' },
